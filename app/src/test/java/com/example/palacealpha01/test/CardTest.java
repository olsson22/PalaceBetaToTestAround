...
{
	/**
	 * The Card.java class's copy_constructor() test relies on Card.java's equals() method. Therefore,
	 * it is crucial for the validity of this test, to test Card.java's equals() method first, which
